<template>
  <div class="container">
    ...
    <div>
      <!--第一行-->
      <el-row>
        <p style="color: #A50001;margin: 12px;font-size: 16px">{{ $t('cultivatingScheme.cultivatingSchemeDetail') }}</p>
      </el-row>
      <!--第二行-->
      <el-row>
        <p style="margin: 12px;text-align: left;font-size: 14px">{{ $t('cultivatingScheme.basicInfomation') }}</p>
      </el-row>
      <!--第三行-->
      <el-row>
    ...
    <!--第三部分-->
    <div class="part3">
      <el-button type="text" style="color:#A50001;font-size: 12px" @click="showCourseSetting">{{$t('cultivatingSchemeQuery.fulu')}}</el-button><br>
    </div>
  </div>
